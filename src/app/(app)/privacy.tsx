    ...
    <Screen edges={['top', 'bottom']}>
      ...
      <ScrollView contentContainerClassName="gap-4 py-2">
        ...
        <Section title="Dónde vive tu información">
          ...
          AWS) y el backend en Google Cloud Run -- fuera de El Salvador. Al usar Budget,
        ...
        <Section title="Menores de edad">
          Budget no está dirigido a menores de 18 años. Si te enterás de que un menor creó
