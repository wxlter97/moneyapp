...
/**
 * Cuerpo de "Personas", en `src/screens/` (no en `src/app/`) para que
 * `app/(app)/balances.tsx` pueda cargarlo con `lazy()` sin que Expo Router
 ...
 * vez de sólo al vuelo al dividir una transacción. Función de Plus (ver
...
export default function BalancesScreen() {
  ...
  return (
    <ProFeatureGate feature="split_people">
      <Pressable
        onPress={() => {
          haptics.tap();
          setAdding((v) => !v);
