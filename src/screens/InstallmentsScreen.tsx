...
/**
 * Cuerpo de "Compras a plazo", en `src/screens/` (no en `src/app/`) para
 * que `app/(app)/installments.tsx` pueda cargarlo con `lazy()` sin que Expo
 * Router también lo registre como su propia ruta -- ver el comentario ahí.
 *
 * Son puro cálculo sobre los cortes de la tarjeta (no hay "registrar
 * cuota" -- ver `apps.accounts.services.installment_status` en el
 * backend). Esta lista solo muestra en qué van. Función de Plus (ver
...
export default function InstallmentsScreen() {
  ...
  return (
    <ProFeatureGate feature="installments">
      <Pressable
        onPress={() => {
          haptics.tap();
