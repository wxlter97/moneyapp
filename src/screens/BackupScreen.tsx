...
/**
 * Cuerpo de la pantalla de respaldo, en `src/screens/` (no en `src/app/`)
 * para que `app/(app)/backup.tsx` pueda cargarlo con `lazy()` sin que Expo
...
export default function BackupScreen() {
  ...
  async function onPickFile() {
    ...
    if (!isBackup(data)) {
      setPickError('Ese archivo no es un respaldo válido de porksupuesto.');
      return;
    }
    setPicked(data);
    haptics.tap();
