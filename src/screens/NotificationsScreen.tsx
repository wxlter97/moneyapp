...
/**
 * Cuerpo de "Notificaciones", en `src/screens/` (no en `src/app/`) para
 * que `app/(app)/notifications.tsx` pueda cargarlo con `lazy()` sin que
 * Expo Router también lo registre como su propia ruta.
 *
 ...
 * que no antes y cambia de opinión. Función de Plus (ver
 * ECONOMIA-POR-PLAN.md) desde el 22-sep-2026 -- los 5 recordatorios que
 * configura acá son justo los que `apps.notifications.services._notify`
 * deja de mandar sin la feature.
 */
export default function NotificationsScreen() {
  ...
  return (
    <ProFeatureGate feature="notifications">
