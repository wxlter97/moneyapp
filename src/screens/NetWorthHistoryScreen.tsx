...
/**
 * Cuerpo de "Patrimonio neto", en `src/screens/` (no en `src/app/`) para que
 * `app/(app)/net-worth-history.tsx` pueda cargarlo con `lazy()` sin que Expo
 * Router también lo registre como su propia ruta.
 *
 * Usa `MonthlySnapshot`, que Celery Beat genera solo el día 1 de cada mes al
 * cerrar el anterior — no hay nada que crear desde la app, solo mostrarlo.
 */
