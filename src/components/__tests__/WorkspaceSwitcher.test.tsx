...
const mockWorkspaces: Workspace[] = [
  { id: 'w1', name: 'Porsupuesto', role: 'owner', member_count: 1 } as Workspace,
...
// Regresión de la auditoría de accesibilidad: el botón "Porsupuesto ⌄" no
...
describe('WorkspaceSwitcher', () => {
  it('el botón tiene un accessibilityLabel que nombra la acción y el workspace activo', async () => {
    ...
    const button = screen.getByLabelText('Cambiar de presupuesto, actual: Porsupuesto');
